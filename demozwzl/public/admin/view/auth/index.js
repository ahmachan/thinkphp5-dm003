...
            case 1:
                param.orderColumn = "a.name";
                break;
						case 2:
                param.orderColumn = "a.account";
                break;
            case 3:
                param.orderColumn ="c.name";
                break;
						case 4:
                param.orderColumn = "b.create_time";
                break;
            }
            param.orderDir = data.order[0].dir;
        }
        //组装查询参数
     	    param.a_name = $("#myform #a_name").val();
          param.a_account = $("#myform #a_account").val();
					param.c_name = $("#myform #c_name").val();
