;(function() {
		...
		$("#validate-form .menu-btn").click(function(){
	   	...
	   	function init_menu(){
	   	  var pool_1=$("#pool_1").val().split(",");
	   	  var pool_2=$("#pool_2").val().split(",");
	   	  var pool_3=$("#pool_3").val().split(",");
	   	  
	   	  for (var i in pool_1) {
				$("#validate-form").find("a[data-code="+pool_1[i]+"]").removeClass("btn-default-alt").addClass("btn-danger-alt");	   	  	 
	   	  }
	   	  for (var i in pool_2) {
	   	  	 	$("#validate-form").find("a[data-code="+pool_2[i]+"]").removeClass("btn-default-alt").addClass("btn-danger-alt");	    	
	   	  }
	   	  for (var i in pool_3) {
	   	  	 	$("#validate-form").find("a[data-code="+pool_3[i]+"]").removeClass("btn-default-alt").addClass("btn-danger-alt");	  
	   	  }
	   	}
})();