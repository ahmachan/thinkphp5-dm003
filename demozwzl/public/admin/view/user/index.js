...
        }
        //组装查询参数
     	    param.nick_name = $("#myform #nick_name").val();
          param.name = $("#myform #name").val();
					param.mobile = $("#myform #mobile").val();
					param.create_time= $("#myform #create_time").val();
        ...
        columns: [
            CONSTANT.DATA_TABLES.COLUMN.CHECKBOX,
            {
                ...
                render:function(data,type, row, meta){
                	if(data==null||data=='null'||data.length<5){
                		return "暂无头像";
                	}else{
                		return "<img style='width:75px;height:75px' src='"+data+"'/>"
                	}
                }
            },
            {	
            ...
            },
            {
                data: "sex",
                render : function(data,type, row, meta){
                	if(data==0){return '保密';}else if(data==1){return	'男';}else{return '女';}
                }
