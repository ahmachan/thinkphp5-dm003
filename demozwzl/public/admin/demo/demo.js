...
$("#demo-color-variations a").click(function(){
    $("head link#styleswitcher").attr("href", $.cookie("assets_url")+'/demo/variations/' + $(this).data("theme"));
    $.cookie('theme',$(this).data("theme"));
    return false;
});

$("#demo-header-variations a").click(function(){
    $("head link#headerswitcher").attr("href",  $.cookie("assets_url")+'/demo/variations/' + $(this).data("headertheme"));
